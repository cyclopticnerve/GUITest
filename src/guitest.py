...
# (e.g. ~/Documents/Projects/Python/Apps/GUITest/gui)
dir_gui = os.path.join(dir_curr, 'gui')

# add gui path to sys path to import handler
sys.path.insert(0, dir_gui)

import GUITestHandler as handler  # noqa: E402 (import not at top of file)
...
def main():
    ...
    # show the window
    guitestApp = GUITesthandler.GUITestApp()  # noqa: E602 (undefined name)
    guitestApp.run()
...
def _parse_args():
    ...
    print('GUITest version PP_VERSION')
